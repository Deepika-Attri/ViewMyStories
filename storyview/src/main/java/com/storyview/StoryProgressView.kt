...
class StoryProgressView : LinearLayout {
    ...
    private val defaultColor = ContextCompat.getColor(context, R.color.white)
    private val defaultBackgroundColor = ContextCompat.getColor(context, R.color.grey)

    private var progressColor = defaultColor
    private var progressBackgroundColor = defaultBackgroundColor

    private val progressBars = ArrayList<StoryProgressBar>()
    ...
    private fun createProgressBar(): StoryProgressBar {
        val p = StoryProgressBar(context, progressColor, progressBackgroundColor)
    ...
    fun setStoriesDurations(durations: LongArray) {
    ...
    fun setCurrentStory(current: Int) {
